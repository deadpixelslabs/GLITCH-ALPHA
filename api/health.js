...
module.exports=async function handler(req,res){
  ...
  res.status(200).json({
    ok:true,
    app:"DEAD PIXELS PORTAL V3.7 // GLITCH ALPHA + UNIFIED EXECUTION OS",
    chainId:4663,
    protocolFeeBps:0,
    ...
    modules:{
      ...
      v37GlitchAlpha:{enabled:true,scope:"UNIVERSAL_ERC20",directOnchainDiscovery:true,historicalSearch:true,multiSource:true}
    },
